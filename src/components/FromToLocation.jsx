                        ...
                        <div className="mb-5 flex flex-wrap justify-start items-center">
                            <div className="px-1.5 pb-2">
                                <button
                                    ...
                                    className={`rounded-full border px-4 py-1.5 text-14 font-bold transition-all duration-300 ${values.trip_type === "one_way"
                                        ? " bg-primary text-primary-foreground1"
                                        : " bg-[#F8FAFC] text-[#00333A]/70 hover:border-primary hover:text-dark"
                                        }`}
                                >
                                    One Way
                                </button>
                            ...
                            <div className="px-1.5 pb-2">
                                <button
                                    ...
                                    className={`rounded-full px-4 py-1.5 text-14 font-bold transition-all duration-300 ${values.trip_type === "round_trip"
                                        ? " bg-primary text-primary-foreground1"
                                        : " text-[#00333A]/70 hover:border-primary hover:text-dark"
                                        }`}
                                >
                                    Round Trip
                                </button>
